                        ...
                        <div className="input-field-creat-club-pic">
                            <div className="profile-image-club">
                                ...
                                <img
                                    ...
                                    id="profilpic"
                                    src={file ? URL.createObjectURL(file) : "FIREBASE_IMAGE_URL_HERE"}
                                    onClick={() => openModalForPic(file ? URL.createObjectURL(file) : "FIREBASE_IMAGE_URL_HERE")}
                                    style={{
                                        width: 125,
                                        height: 125,
                                        position: 'absolute',
                            ...
                            <div className="profile-image-club">
                                ...
                                <img
                                    className={"open-img-creat-club"}
                                    id="profilpic"
                                    onClick={() => openModalForPic(fileCover ? URL.createObjectURL(fileCover) : "FIREBASE_IMAGE_URL_HERE")}
                                    src={fileCover ? URL.createObjectURL(fileCover) : "FIREBASE_IMAGE_URL_HERE"}
                                    style={{
                                        width: 125,
                                        height: 125,
                                        position: 'absolute',
